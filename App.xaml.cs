...
namespace Process_Affinity_Utility
{
    ...
    public partial class App : Application
    {
        ...
        /// <summary>
        /// This property is used to know if a minimize to tray argument was given at the program start
        /// </summary>
        ...
        Mutex mutex = new System.Threading.Mutex(false, "426ab1e1-7f92-4880-9a7f-1c1082fc6891");
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Args.Length > 0)
                {
                    ...
                    {
                        if (arg.ToLowerInvariant().Contains("minimize"))
                            StartMinimizedToTray = true;
                        else if (arg.ToLowerInvariant().Contains("dark"))
                            IsDarkTheme = true;
